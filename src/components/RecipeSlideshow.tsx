    ...
    <div className="relative rounded-3xl overflow-hidden shadow-2xl mb-12 group">
      ...
      <div className="relative h-72 md:h-96 lg:h-[500px]">
        {recipes.map((recipe, index) => (
          ...
          >
            <Link to={`/recipe/${recipe.idMeal}`} className="block w-full h-full">
              {/* Background Image */}
              <div 
      ...
      <button
        onClick={prevSlide}
        className="absolute left-4 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-white/20 backdrop-blur-sm hover:bg-white/30 rounded-full flex items-center justify-center text-white transition-all duration-300 opacity-0 group-hover:opacity-100 hover:scale-110"
      ...
      <button
        onClick={nextSlide}
        className="absolute right-4 top-1/2 transform -translate-y-1/2 w-12 h-12 bg-white/20 backdrop-blur-sm hover:bg-white/30 rounded-full flex items-center justify-center text-white transition-all duration-300 opacity-0 group-hover:opacity-100 hover:scale-110"
